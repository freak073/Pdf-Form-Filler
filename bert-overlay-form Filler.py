...
if __name__ == "__main__":
    ...
    # Step 4: Map form fields to knowledge base entries using BERT
    ...
    images_to_pdf([os.path.join(output_dir, f'marked_page_{i + 1}.png') for i in range(len(image_paths))], output_pdf_path)
