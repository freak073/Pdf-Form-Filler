...
# Step 3: Rule-Based Mapping Function
...
# Define the images_to_pdf function before process_pdf
...
if __name__ == "__main__": 
    ...
    # Construct the paths
    input_pdf = os.path.join(script_dir, 'Dummy_Questionnaire_wq.pdf')
    output_dir = os.path.join(script_dir, 'output')
    knowledge_base_path = os.path.join(script_dir, 'dummy_data.txt')
    ...
    # Step 2: Extract form fields from the PDF
    print("Extracting form fields from PDF...")
    form_fields = extract_form_fields_from_pdf(input_pdf)

    # Step 3: Parse the knowledge base
    print("Parsing knowledge base...")
    knowledge_base = parse_knowledge_base(knowledge_base_path)

    # Step 4: Map form fields to knowledge base entries using rule-based mapping
    print("Mapping form fields to knowledge base entries...")
    ...
    # Step 6: Convert marked images to a single PDF
    print("Converting marked images to a single PDF...")
    output_pdf_path = os.path.join(output_dir, 'final_output.pdf')
